                          ...
                          child: new Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: NeumorphicButton(
                                  onClick: () async {
                                    print("-------------------------------------\n" +widget.info.filePath.toString()+ "======="+playBloc.state.toString()+ "======="+widget.player.playbackState.toString() + "======="+songData.state.toString() +"-------------------------------------\n");
                                  ...
                                  style: isDark ? dark_softUI : light_softUI,
                                  child: new Icon(
                                      ( widget.player.playbackState ==AudioPlaybackState.playing)
                                          ? Icons.pause
                                          : Icons.play_arrow,
                                      size: 60.0),
                                ),
          ...
          child: new Container(
            ...
            child: new Neumorphic(
                ...
                child: Hero(
                    ...
                    child: new Container(
                        child: new Image(
                      image: new AssetImage('assets/images/YouTube_Music.png'),
