...
import 'package:flute_music/detail_page/repository/song_title_bloc.dart';
...
class _MyHomePageState extends State<MyHomePage>
  ...
  Widget build(BuildContext context) {
    ...
    final songTitle = BlocProvider.of<SongTitleBloc>(context);
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: ClipRRect(
                              ...
                              child: new Image(
                                image:
                                    AssetImage('assets/images/ky.png'),
                              ),
                            ),
                          ),
                        ),
                                                  ...
                                                  child: BlocBuilder<PlayBloc,
                                                    ...
                                                    builder:
                                                      ...
                                                      return Icon(
                                                        (songData.state ==
                                                                    info.filePath &&
                                                                (isPlaying || ( player.playbackState ==AudioPlaybackState.playing)))
                                                            ? Icons.pause
                                                            : Icons.play_arrow,
